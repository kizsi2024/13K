        ...
        (__unused_webpack_module, exports, __w_pdfjs_require__) => {
          ...
          class PDFPageProxy {
            ...
            getXfa() {
              return (
                this._xfaPromise ||
                (this._xfaPromise = this._transport.getPageXfa(this._pageIndex))
              );
            }
            render({
              canvasContext: e,
              ...
              const s = new WeakMap(),
                r = {
                  data: (function cloneValue(e) {
                    ...
                    if (e instanceof URL)
                      throw new Error(
                        `LoopbackPort.postMessage - cannot clone: ${e}`
                      );
          ...
          const o = (function CanvasGraphicsClosure() {
            ...
            class CanvasGraphics {
              ...
              showText(e) {
                ...
                if (0 === y || 0 === _) {
                  const e =
                    t.textRenderingMode & r.TextRenderingMode.FILL_STROKE_MASK;
                  if (
              ...
              beginGroup(e) {
                ...
                let n = r.Util.getAxialAlignedBoundingBox(
                  e.bbox,
            ...
            for (const e in r.OPS)
              CanvasGraphics.prototype[r.OPS[e]] = CanvasGraphics.prototype[e];
        ...
        (e, t, s) => {
          ...
          class MeshShadingPattern extends BaseShadingPattern {
            ...
            getPattern(e, t, s) {
              ...
              let n;
              if (s)
                n = r.Util.singularValueDecompose2dScale(e.mozCurrentTransform);
              else {
          ...
          function render(e) {
            ...
            if (r > 1e5) {
              ...
              if (!e._textContentStream)
                for (let s = 0; s < r; s++) e._layoutText(t[s]);
              e._renderingDone = !0;
              s.resolve();
            }
          }
          ...
          t.SVGGraphics = i;
          {
            const e = {
              ...
              h = (function () {
                ...
                return function convertImgDataToPng(e, t, s) {
                  return encode(
                    e,
                    void 0 === e.kind ? r.ImageKind.GRAYSCALE_1BPP : e.kind,
                    t,
                    s
                  );
                };
            ...
            t.SVGGraphics = i = class {
              ...
              showText(t) {
                ...
                const A =
                  n.textRenderingMode & r.TextRenderingMode.FILL_STROKE_MASK;
                if (
                  A === r.TextRenderingMode.FILL ||
                  A === r.TextRenderingMode.FILL_STROKE
                ) {
        ...
        (e, t) => {
          ...
          t.XfaLayer = class XfaLayer {
            ...
            static setAttributes(e, t, s) {
              ...
              s &&
                void 0 !== r.fieldId &&
                this.setupStorage(e, r.fieldId, t, s);
            }
            static render(e) {
          ...
          class PDFNodeStreamFsFullReader extends BaseFullReader {
            constructor(e) {
              ...
              a.lstat(t, (e, s) => {
                if (e) {
                  "ENOENT" === e.code &&
                    (e = new r.MissingPDFException(`Missing PDF "${t}".`));
                  this._storedError = e;
                  this._headersCapability.reject(e);
                } else {
        ...
        c = __w_pdfjs_require__(21);
      {
        ...
        if (e) {
          ...
          (0, t.isFetchSupported)() &&
            (r = __w_pdfjs_require__(26).PDFFetchStream);
